...
function elementor_aea_widgets_dependencies() {
    ...
    wp_register_style('anber-price-tab', plugins_url('assets/css/anber-price-tab.css', __FILE__));
    ...
    wp_enqueue_style('adon-comon-style');
    wp_enqueue_style('anber-carousel-style');
    wp_enqueue_style('anber-price-tab');
    wp_enqueue_style('anber-carousel');
    wp_enqueue_style('anber-magnific-popup');

    /* Scripts */
    wp_register_script('anber-carousel', plugins_url('assets/js/anber-carousel.js', __FILE__), ['jquery'], null, true);
    wp_register_script('anber-carousel-script', 'https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.1.3/owl.carousel.min.js', ['jquery'], null, true);
    wp_register_script('anber-magnific-popup', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.js', ['jquery'], null, true);

    wp_enqueue_script('anber-carousel');
    wp_enqueue_script('anber-carousel-script');
    wp_enqueue_script('anber-magnific-popup');
}
